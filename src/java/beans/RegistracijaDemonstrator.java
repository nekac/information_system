 ...
 * @author Nikola
 */
@ManagedBean (name="registracijaDemonstrator")
@RequestScoped
public class RegistracijaDemonstrator {
    ...
    private Double prosek = null;

    public RegistracijaDemonstrator() {}
    ...
    public RegistracijaDemonstrator(String userName, String password, String passwordConfirm, String name, String surname, String telNumber, String email, String image, String odsek, Integer godina, Double prosek) {
