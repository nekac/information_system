 ...
 * @author Nikola
 */
@ManagedBean (name="dodajNastavnika")
@RequestScoped
public class DodajNastavnika {
    ...
    public DodajNastavnika(String userName, String password, String passwordConfirm, String name, String surname, String telNumber, String email, String image) {
    ...
    public String registrujNastavnika() {
